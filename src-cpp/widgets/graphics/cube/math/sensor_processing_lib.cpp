...
vector_ijk update_gravity_vector ( vector_ijk gravity_vector, float wx, float wy, float wz, double delta )
{
...
vector_ijk update_fused_vector ( vector_ijk fused_vector, float ax, float ay, float az, float wx, float wy, float wz, double delta )
{
