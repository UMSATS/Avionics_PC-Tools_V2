 ...
 * @return status code
 */
CSERIAL_EXPORT int c_serial_write_data( c_serial_port_t* port, void* data, unsigned length, unsigned * bytes_written );
 ...
 */
CSERIAL_EXPORT int c_serial_read_data( c_serial_port_t* port, void* data, unsigned data_length, unsigned * bytes_read, c_serial_control_lines_t* lines );

CSERIAL_EXPORT int c_serial_read_data_blocking ( c_serial_port_t* port, void* data, unsigned data_length, unsigned *bytes_read );
CSERIAL_EXPORT int c_serial_write_data_blocking ( c_serial_port_t* port, void* data, unsigned data_length, unsigned *bytes_written );
